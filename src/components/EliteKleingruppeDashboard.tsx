                ...
                <div className="space-y-3">
                  ...
                  >
                    <div className="flex-shrink-0 p-2 bg-rose-100 rounded-lg">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-rose-600"><path d="m22 8-6 4 6 4V8Z"/><rect width="14" height="12" x="2" y="6" rx="2" ry="2"/></svg>
                    </div>
                    <div className="ml-3 text-left">
                      <p className="text-sm font-medium text-gray-900">Video Pläne</p>
                      <p className="text-xs text-gray-500">Elite-Kleingruppe Videos</p>
                    </div>
                  </a>
                </div>
              </div>
