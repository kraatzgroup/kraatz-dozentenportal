...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const emailSubject = `Ihre Klausur wurde korrigiert: ${klausurTitle}`;
    ...
    if (!mailgunResponse.ok) {
      ...
      await logNotification({
        edgeFunction: 'klausur-correction-notify',
        supabaseAdmin,
        ...
        context: { klausurTitle, legalArea, score },
        payload: { teilnehmerEmail, teilnehmerName, klausurTitle, legalArea, score, feedback },
      });
