/*
  ...
  1. Changes
    ...
    - Fix issues with file access for admins
    - Ensure proper access to storage objects
...
BEGIN
  ...
  RAISE NOTICE 'Admins can now view all files in storage';
  RAISE NOTICE 'Users can view their own files in storage';
END $$;